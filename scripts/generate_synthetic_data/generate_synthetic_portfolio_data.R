box::use(
  scripts / generate_synthetic_data / synthetic_file_paths[synth_fp]
)
library(dplyr)
...
arrow::write_parquet(portfolio_data, file.path("scripts", "raw_data", "test_data", "synthetic_portfolio.parquet"))
readr::write_csv(portfolio_data, file.path("scripts", "raw_data", "test_data", "synthetic_portfolio.csv"))
